...
TILES = [('empty', ' '),
         ...
         ('diag3', '\\'),
         ('diag4', '/'),
         ('tent1', f'{WHITE_FORE}W{RESET_COLORS}'),
         ('tent2', f'{WHITE_FORE}W{RESET_COLORS}'),
         ('tent3', f'{WHITE_FORE}W{RESET_COLORS}'),
         ('tent4', f'{WHITE_FORE}W{RESET_COLORS}'),
         ('girder_vert', f'{WHITE_FORE}|{RESET_COLORS}'),
         ('girder_horiz1', f'{WHITE_FORE}-{RESET_COLORS}'),
         ('girder_horiz2', f'{WHITE_FORE}-{RESET_COLORS}'),
         ('low_grass', '_'),
         ('trunk', '|'),
